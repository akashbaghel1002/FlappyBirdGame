...
def mainGame():
    ...
    while True:
        ...
        for upperPipe,lowerPipe in zip(upperPipes,lowerPipes):
         ...
         # add a new pipe when the first is about to cress the leftmost part of the screen
...
if __name__ == '__main__':
    ...
    pygame.init()#Intialize all pygame's module
    ...
    while True:
        welcomeScreen() #Shows welcome screen to the user until he pressed any key
        mainGame()
